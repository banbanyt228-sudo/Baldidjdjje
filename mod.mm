...
// ================= ОФФСЕТЫ =================
// Замените на точные значения под вашу версию игры из dump.cs:
#define OFFSET_STAMINA_CHECK     0x123456 // PlayerScript.StaminaCheck()
#define OFFSET_DETECT_COLLISIONS 0x234567 // UnityEngine.CharacterController.set_detectCollisions(bool)
// ============================================
...
static void InitMod() {
    ...
    // Бесконечная стамина: глушим StaminaCheck() инструкцией RET
